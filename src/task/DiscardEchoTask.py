    ...
    def __init__(self, *args, **kwargs):
        ...
        self.default_config = {
            ...
            'Keep 1C ATK': [
                ...
                'Sun-sinking Eclipse', 'Rejuvenating Glow', 'Moonlit Clouds', 'Lingering Tunes',
                'Frosty Resolve', 'Eternal Radiance', 'Midnight Veil', 'Empyrean Anthem', 'Tidebreaking Courage'],
            'Keep 3C HP': [],
            'Keep 3C DEF': [],
            'Keep 3C ATK': ['Lingering Tunes', 'Sun-sinking Eclipse', 'Freezing Frost', 'Molten Rift', 'Void Thunder', 'Sierra Gale', 'Celestial Light',
                            'Frosty Resolve', 'Eternal Radiance', 'Midnight Veil', 'Empyrean Anthem', 'Tidebreaking Courage'],
            ...
            'Keep 3C Spectro DMG': ['Celestial Light', 'Moonlit Clouds', 'Eternal Radiance'],
            'Keep 3C Havoc DMG': ['Sun-sinking Eclipse', 'Moonlit Clouds', 'Midnight Veil'],
            'Keep 3C Glacio DMG': ['Freezing Frost', 'Moonlit Clouds', 'Frosty Resolve'],
            'Keep 3C Energy Regen': [
                'Freezing Frost', 'Molten Rift', 'Void Thunder', 'Sierra Gale', 'Celestial Light',
                'Sun-sinking Eclipse', 'Rejuvenating Glow', 'Moonlit Clouds', 
                'Empyrean Anthem', 'Tidebreaking Courage'
                ],
            ...
            'Keep 4C Crit DMG': ['Freezing Frost', 'Molten Rift', 'Void Thunder', 'Sierra Gale', 'Celestial Light',
                                 'Sun-sinking Eclipse', 'Rejuvenating Glow', 'Moonlit Clouds', 'Lingering Tunes',
                                 'Frosty Resolve', 'Eternal Radiance', 'Midnight Veil', 'Empyrean Anthem', 'Tidebreaking Courage'],
            'Keep 4C Healing': ['Moonlit Clouds', 'Rejuvenating Glow'],
            'Keep 4C HP': ['Moonlit Clouds', 'Rejuvenating Glow'],
            'Keep 4C DEF': [],
            'Keep 4C ATK': [
                'Freezing Frost', 'Molten Rift', 'Void Thunder', 'Sierra Gale', 'Celestial Light',
                'Sun-sinking Eclipse', 'Rejuvenating Glow', 'Moonlit Clouds', 'Lingering Tunes',
